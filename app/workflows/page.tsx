...
import { Plus, Workflow, Play, Pause, Eye } from 'lucide-react';
...
const userWorkflows = [
  ...
  },
  {
    ...
    description: 'Handle customer inquiries and route to appropriate assistants',
    status: 'idle',
    lastRun: '1 day ago',
    steps: 3,
    successRate: '88%'
          ...
          <div className="text-center py-16 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                Create automated workflows to connect your AI assistants and streamline processes
              </p>
            </div>
